...
class treeNode {
    public:
        ...
        *****************/
        ...
        int line_no;                  //line number in source code

        int isconst;                  //whether vlue known at compile time or not

        int value;                    //value of node if it is known at compile time

        int numbering;                //value numbering
       /*****************
        * END IR FIELDS
       *****************/
